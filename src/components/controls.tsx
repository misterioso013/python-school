...
import type { CodeSettingsProps } from '@/components/code-settings';
interface ControlProps extends CodeSettingsProps {
  items: {
    label: string
    icon: any
    onClick: () => void
...
export function Controls(props: ControlProps) {
  ...
  return (
    <div className="fixed pointer-events-none z-10 -mb-16 flex justify-end p-2 right-1">
